...
function resultBox(){
  ...
  if (dwcsSigned){
    ...
    fw.innerHTML = 'You beat <b>'+o.f.name+'</b> on Dana White\'s Contender Series. The call comes the '+
      'next morning: a standard UFC contract, a spot in the '+DIVLABEL()+' rankings, a real division '+
      'ahead of you. Everything from here is on the record.';
    p.appendChild(fw);
  }
