...
(function(){
  ...
  var cards=[[ic.c,'Fighter analytics','Full career stats for all 3,000+ fighters'],[ic.s,'Fight simulator','Predicts the winner and the method up to 50,000 times'],[ic.b,'Box scores','Head-to-head data for every bout ever'],[ic.a,'Accolades','Titles, belt ranks, records, and fight-night awards for every fighter — belt rank first, then championships newest to oldest'],[ic.o,'Live odds','Moneyline, round totals, method-of-victory and round props by book for every upcoming fight'],[ic.h,'Historical odds','Closing-line history for every fighter, bout by bout'],[ic.t,'Tape study','One click from any fight to the film'],[ic.r,'Rankings','Media panel and Meta AI rankings, updated after every event'],[ic.u,'Roster tracker','Weekly signings and cuts'],[ic.f,'Instant search','See detailed analytics for any fighter, past or present, with a quick search']];
