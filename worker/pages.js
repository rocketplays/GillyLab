...
(function(){
  ...
  function rcol(title,color,items,first){var shown=items.slice(0,6),extra=items.length-shown.length;return '<div style="'+(first?'':'margin-top:1.1rem;padding-top:1.1rem;border-top:1px solid rgba(255,255,255,.08)')+'"><div style="display:flex;align-items:center;gap:.45rem;font-size:.72rem;font-weight:800;letter-spacing:.05em;text-transform:uppercase;color:'+color+';margin-bottom:.6rem"><span>'+title+'</span><span style="background:'+color+'22;border-radius:999px;padding:.05rem .5rem;font-size:.7rem">'+items.length+'</span></div><div style="display:flex;flex-direction:column;gap:.4rem">'+(items.length?shown.map(function(n){return '<div style="display:flex;align-items:center;gap:.55rem;font-size:.92rem"><span style="color:'+color+';font-size:.58rem">●</span><span>'+n+'</span></div>';}).join(''):'<div style="color:'+M+';font-size:.85rem">None</div>')+(extra>0?'<div style="color:'+M+';font-size:.8rem;padding-left:1.1rem">+'+extra+' more</div>':'')+'</div></div>';}
  var roster='<div style="border:1px solid rgba(255,255,255,.1);border-radius:12px;background:rgba(255,255,255,.025);padding:1.1rem 1.3rem"><div style="font-size:.8rem;font-weight:700;color:rgba(255,255,255,.55);margin-bottom:1rem">'+LD.roster.week+'</div>'
    +rcol('Added','#00e668',LD.roster.added,true)
    +rcol('Removed','#ff9500',LD.roster.removed,false)+'</div>';
