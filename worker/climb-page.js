...
function offerBox(){
  ...
  for(const o of list){
    ...
    const rk = titleShot ? 'CHAMPION' : (o.f.rankNum===99?'Unranked':(o.f.rankNum===0?'CHAMPION':'#'+o.f.rankNum));
...
function planBox(){
  ...
  const rk = (o.titleFight && !o.defense) ? 'CHAMPION' : (o.f.rankNum===99?'Unranked':(o.f.rankNum===0?'CHAMPION':'#'+o.f.rankNum));
