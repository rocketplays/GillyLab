...
// TEMPORARY — the candidate landing page (free/premium feature grid instead of the
// 14-slide carousel), served at /landingpagetest so it can be judged on a real phone
// before it replaces /. Generated by scripts/gen-showcase-proto.cjs from this same
// pages.js, so the preview is the real previews and not a mockup.
// WHEN IT SHIPS (or is rejected): delete this import, the /landingpagetest route below,
// worker/landing-test.js, and the generator's Worker output.
import { landingTestPage } from "./landing-test.js";
...
export default {
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      // cannot be mistaken for / by a crawler while it exists.
      if (path === "/landingpagetest") return html(landingTestPage());
