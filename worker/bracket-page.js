...
<style>
  ...
  *{ box-sizing:border-box; }
  ...
  .view-lb-btn{
    ...
    letter-spacing:0.05em; text-transform:uppercase; color:var(--accent-2); background:transparent;
    border:1px solid var(--accent-2); border-radius:6px; padding:0.5rem 0.9rem; cursor:pointer;
    transition:background 0.12s, color 0.12s;
  }
  .view-lb-btn:hover{ background:color-mix(in srgb, var(--accent-2) 14%, transparent); }
